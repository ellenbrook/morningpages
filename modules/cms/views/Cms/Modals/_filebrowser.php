			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-xs-3 filebrowser-info">
						...
						<div class="row-fluid">
							<div class="col-xs-6" id="filebrowser-preview-image">
								
							</div>
							<div class="col-xs-6" id="filebrowser-preview-info">
						...
						<div class="filebrowser-forms hide">
							<div class="form-group">
								...
								<input type="text" id="filebrowser-titletext" class="form-control" />
							</div>
							<div class="form-group">
								<label for="filebrowser-description">Beskrivelse</label>
								<textarea id="filebrowser-description" class="form-control"></textarea>
							</div>
							<div class="form-group">
								<label for="filebrowser-size">Størrelse</label>
								<select id="filebrowser-size" class="form-control">
